...
"color: rgb(86, 1, 38);"));
        ...
        page->setGeometry(QRect(0, 0, 191, 322));
        ...
        page_2->setGeometry(QRect(0, 0, 172, 339));
...
"color: rgb(86, 1, 38);"));
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/new/prefix1/icons/external-link.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::On);
        ...
        QIcon icon2;
        icon2.addFile(QString::fromUtf8("../../../Atelier_Connexio/Atelier_Connexion/Atelier_Connexion/icons/align-left.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::On);
        ...
        QIcon icon3;
        icon3.addFile(QString::fromUtf8("../../../Atelier_Connexio/Atelier_Connexion/Atelier_Connexion/icons/search.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::On);
        ...
        QIcon icon4;
        icon4.addFile(QString::fromUtf8("../../../Atelier_Connexio/Atelier_Connexion/Atelier_Connexion/icons/delete.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::On);
...
"color: rgb(86, 1, 38);"));
        ...
        QIcon icon9;
        icon9.addFile(QString::fromUtf8(":/new/prefix1/icons/box.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::On);
