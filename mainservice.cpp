    ...
    mainMaintenance(nullptr)
{
    ...
    checkServiceStatus();
    connect(ui->aff_statistique, &QPushButton::clicked, this, &MainService::afficherStatistiquesDansTable);
...
MainService::~MainService()
{
    ...
    delete arduinoWindow;
    delete mainMaintenance;
}

void MainService::afficherStatistiquesDansTable()
{
...
void MainService::checkServiceStatus()
{
    ...
    for (int i = 0; i < model->rowCount(); ++i) {
        ...
        QString dateFinStr = model->data(model->index(i, 7)).toString();
...
void MainService::on_pushButton_annuler_clicked()
{
    ui->le_id_ser->clear();
    ui->le_nom->clear();
    ui->le_prix->clear();
...
void MainService::on_pushButton_annuler_2_clicked()
{
...
void MainService::on_pushButton_modifier_clicked()
{
...
void MainService::on_pushButton_annuler_3_clicked()
{
    ui->id_supp->clear();
}

void MainService::on_pb_rechercher_clicked()
{
...
void MainService::on_pushButton_annuler_search_clicked()
{
    ui->le_recherche->clear();
    ui->tab_Services->setModel(s.afficher());
}

void MainService::exportTableToPDF(QTableView *table, const QString &filename)
{
    if (!table) return;
...
void MainService::on_pushButton_telecharger_pdf_clicked()
{
...
void MainService::on_tab_Services_clicked(const QModelIndex &index)
{
...
void MainService::on_pb_tier_clicked()
{
    QString critere = ui->le_trier->currentText().trimmed().toLower();
...
void MainService::on_pushButton_fonctionnalites_2_clicked()
{
    ui->stackedWidget->setCurrentWidget(ui->page_4);
}

void MainService::on_pushButton_crud_2_clicked()
{
    ui->stackedWidget->setCurrentWidget(ui->page_3);
}

void MainService::on_actualiser_clicked()
{
    notificationPanel->clearNotifications();
    checkServiceStatus();
}

void MainService::ajouterHistorique(const QString &operation)
{
    ...
    ui->listWidgetHistorique->scrollToBottom();
}

void MainService::on_pushButton_exp_clicked()
{
...
void MainService::on_pushButton_12_clicked()
{
    if (!mainMaintenance) {
