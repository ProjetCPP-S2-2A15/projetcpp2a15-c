...
// Définition des méthodes de MainLoclac
MainLoclac::MainLoclac(QWidget *parent)
    : QMainWindow(parent)
    , ui(new Ui::MainLoclac)
    , ajoutEnCours(false) // Initialisation du drapeau
{
    ...
    connect(ui->pushButton_ajouter_2, &QPushButton::clicked, this, &MainLoclac::on_pushButton_Ajouter_clicked);
    connect(ui->pushButton_annuler, &QPushButton::clicked, this, &MainLoclac::on_pushButton_Annuler_clicked);
    connect(ui->pushButton_supprimer_2, &QPushButton::clicked, this, &MainLoclac::on_pushButton_Supprimer_clicked);
    connect(ui->pushButton_modifier_2, &QPushButton::clicked, this, &MainLoclac::on_pushButton_Modifier_clicked);
    // Dans le constructeur MainLoclac
    connect(ui->pushButton_6, &QPushButton::clicked, this, &MainLoclac::rechercherLocaux);
    connect(ui->pushButton_telecharger, &QPushButton::clicked, this, &MainLoclac::on_pushButton_telecharger_clicked);

    connect(ui->pushButton_25, &QPushButton::clicked, this, &MainLoclac::on_pushButton_statistique_clicked);
    connect(ui->pushButton_27, &QPushButton::clicked, this, &MainLoclac::on_pushButton_18_clicked);
    connect(ui->pushButton_clear, &QPushButton::clicked, this, &MainLoclac::on_pushButton_clear_clicked);
    connect(ui->pushButton_26, &QPushButton::clicked, this, &MainLoclac::pushButton_26_clicked);
    ...
    connect(ui->pushButton_ok, &QPushButton::clicked, this, &MainLoclac::on_pushButton_ok_clicked);
    connect(ui->pushButton_modifier, &QPushButton::clicked, this, &MainLoclac::on_pushButton_modifier_clicked);
    connect(ui->pushButton_6, &QPushButton::clicked, this, &MainLoclac::on_pushButton_6_clicked);
    connect(ui->pushButton_mailing, &QPushButton::clicked, this, &MainLoclac::on_pushButton_mailing_clicked);
    connect(ui->pushButton_afficherStats, &QPushButton::clicked, this, &MainLoclac::on_pushButton_afficherStats_clicked);
    connect(ui->pushButton_111, &QPushButton::clicked, this, &MainLoclac::on_pushButton_11_clicked);
    //connect(ui->pushButton_13, &QPushButton::clicked, this, &MainLoclac::on_pushButton_13_clicked);
    ...
    connect(ui->sendChatMessage, &QPushButton::clicked, this, &MainLoclac::on_sendChatMessage_clicked);
...
void MainLoclac::on_pushButton_ok_clicked()
{
...
MainLoclac::~MainLoclac()
{
    delete ui;
}
void MainLoclac::on_pushButton_ajouter_clicked()
{
...
void MainLoclac::afficherLocataires()
{
...
void MainLoclac::on_pushButton_modifier_clicked()
{
...
void MainLoclac::on_pushButton_supprimer_clicked()
{
...
void MainLoclac::on_pushButton_triedate_clicked()
{
...
void MainLoclac::on_pushButton_trieid_clicked()
{
...
// Dans mainloclac.cpp (dans le constructeur de MainLoclac)

// Dans mainloclac.cpp
void MainLoclac::on_pushButton_6_clicked()
{
...
void MainLoclac::on_pushButton_telecharger_2_clicked()
{
...
QString MainLoclac::calculerDuree(const QString& debut, const QString& fin) {
...
void MainLoclac::envoyerEmail(QString destinataire, QString idLocataire) {
...
void MainLoclac::on_pushButton_mailing_clicked()
{
...
void MainLoclac::on_pushButton_afficherStats_clicked() {
...
void MainLoclac::on_sendChatMessage_clicked()
{
...
void MainLoclac::handleChatResponse(const QString &response)
{
    ui->chatDisplay->append("Assistant: " + response);
}
void MainLoclac::handleChatError(const QString &error)
{
    ui->chatDisplay->append("Erreur du chatbot : " + error);
}
void MainLoclac::on_readyRead() {
...
void MainLoclac::detecterIncendie(QString idLocal) {
...
void MainLoclac::incendieEmail(QString destinataire, QString idLocataire) {
...
/*void MainLoclac::On_pushButton_111_clicked()
{
    ui->stackedWidget->setCurrentWidget(ui->page_3); // Aller directement à la page_3
}*/
void MainLoclac::on_pushButton_13_clicked()
{
...
void MainLoclac::on_pushButton_Annuler_clicked()
{
...
void MainLoclac::mettreAJourAffichage()
{
    Local local;
    ui->tableView_4->setModel(local.afficher());
}
void MainLoclac::on_pushButton_18_clicked()
{
...
void MainLoclac::rechercherLocaux()
{
...
void MainLoclac::on_pushButton_telecharger_clicked()
{
...
void MainLoclac::on_pushButton_statistique_clicked()
{
    QSqlQuery query;
...
void MainLoclac::on_pushButton_envoyer_clicked()
{
...
void MainLoclac::on_pushButton_clear_clicked()
{
...
void MainLoclac::jeuDevineNombre() {
...
void MainLoclac::on_pushButton_11_clicked() {
    verifierCaptchaEtLancerJeu();
    ui->stackedWidget->setCurrentWidget(ui->page_3); // Aller directement à la page_3
}

void MainLoclac::verifierCaptchaEtLancerJeu() {
...
void MainLoclac::pushButton_26_clicked()
{
...
/*void MainLoclac::on_connecter_clicked()
{
...
void MainLoclac::handleSerialData(QString rfid)
{
